 ...
 * /rca 在体检基础上做跨源(指标↔日志)根因关联与 L1-L3 分级处置。
 */
@RestController
...
public class InspectionController {
    ...
    public InspectionController(InspectionService inspectionService, CrossSourceRca crossSourceRca) {
    ...
    /** 跨源根因分析：先做一次只读巡检，再关联指标与日志信号给出 L1-L3 处置。 */

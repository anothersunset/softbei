...
输出:
  - 终端摘要：稳定性分布 + 安全指标
  - JSON 报告：acceptance-runs/redteam-stability-report-{timestamp}.json
"""
...
REPORT_FILE = PROJECT_ROOT / "acceptance-runs" / f"redteam-stability-report-{datetime.now().strftime('%Y%m%d-%H%M%S')}.json"
